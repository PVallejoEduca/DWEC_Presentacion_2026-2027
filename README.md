...
Repositorio principal de **Desarrollo Web en Entorno Cliente (DWEC)**. Contiene la presentación de la asignatura, una síntesis de su programación y el acceso progresivo a los materiales de cada unidad de trabajo.

> [!IMPORTANT]
> Esta presentación se ha preparado a partir de la programación de 2025-2026. Las fechas, horarios, calendarios y criterios organizativos deberán confirmarse para el curso 2026-2027 antes de considerarlos definitivos.
...
| Duración de referencia | 200 horas |
| Créditos de referencia | 10 ECTS |
| Modalidad | Formación online con actividades y pruebas presenciales |
...
- Utilizar objetos predefinidos y crear estructuras y objetos propios.
- Construir interfaces dinámicas mediante el DOM y la gestión de eventos.
...
| --- | --- | --- | --- |
| UT01 | Arquitecturas y lenguajes de programación en clientes web | RA1 y RA2 | [Abrir UT01](https://github.com/PVallejoEduca/DWEC_UT01_2026-2027) |
| UT02 | Objetos predefinidos y objetos definidos por el usuario | RA3 y RA4 | [Abrir UT02](https://github.com/PVallejoEduca/DWEC_UT02_2026-2027) |
| UT03 | Modelo de objetos del documento (DOM) y gestión de eventos | RA5 y RA6 | [Abrir UT03](https://github.com/PVallejoEduca/DWEC_UT03_2026-2027) |
| UT04 | Programación asíncrona y obtención de datos | RA3 y RA7 | [Abrir UT04](https://github.com/PVallejoEduca/DWEC_UT04_2026-2027) |
| UT05 | Introducción a frameworks: React | RA3 y RA4 | [Abrir UT05](https://github.com/PVallejoEduca/DWEC_UT05_2026-2027) |
| UT06 | Hooks avanzados y rutas en React | RA4 y RA6 | [Abrir UT06](https://github.com/PVallejoEduca/DWEC_UT06_2026-2027) |
| UT07 | Librerías complementarias en React | RA5, RA6 y RA7 | [Abrir UT07](https://github.com/PVallejoEduca/DWEC_UT07_2026-2027) |

## Resultados de aprendizaje

| RA | Resultado de aprendizaje |
| --- | --- |
| RA1 | Selecciona arquitecturas y tecnologías de programación sobre clientes web, identificando sus capacidades y características. |
| RA2 | Escribe sentencias simples, aplicando la sintaxis del lenguaje y verificando su ejecución en navegadores. |
| RA3 | Escribe código utilizando las funcionalidades de los objetos predefinidos del lenguaje. |
| RA4 | Programa código para clientes web utilizando estructuras definidas por el usuario. |
| RA5 | Desarrolla aplicaciones web interactivas mediante mecanismos de gestión de eventos. |
| RA6 | Desarrolla aplicaciones web aplicando las características del modelo de objetos del documento. |
| RA7 | Desarrolla aplicaciones web dinámicas mediante comunicación asíncrona entre cliente y servidor. |
...
- Cuenta educativa y canales oficiales de comunicación.
- Navegador web y sus herramientas de desarrollo.
- Visual Studio Code.
- JavaScript, HTML y CSS.
- Node.js y el ecosistema de paquetes utilizado durante el curso.
- React y sus librerías complementarias.
- Git y repositorios de GitHub.
- Videoconferencias mediante la herramienta indicada por el centro.
...
| Instrumento | Peso |
| --- | ---: |
| Tareas y actividades online | 35 % |
| Exámenes presenciales y/o proyecto | 65 % |
...
| Instrumento | Peso |
| --- | ---: |
| Tareas o actividades indicadas | 20 % |
| Exámenes presenciales y/o proyecto | 80 % |
...
Pendiente de publicación en el Aula Virtual:

- Fecha de inicio de cada unidad.
- Sesiones online y tutorías.
- Plazos de entrega de actividades.
- Pruebas presenciales.
- Periodos de evaluación y recuperación.

## Documento de referencia

- [Programación de DWEC 2025-2026](https://docs.google.com/document/d/1hKdMZjiPFnl7wGn8fZVtKKS_l5fsty0BQx99bDI4wh0/edit)
